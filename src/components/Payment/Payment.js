        ...
        <div className='paymentContainer'>
            ...
            <Fragment>
                ...
                <div class="card-Payment text-center">
                    ...
                    <div class="card-body bg-light border border-warning">
                        ...
                        <div class="card-header border border-warning">
                            ...
                            <h2 align='center bg-light' className='PaymentTitle'>Make Your Payment</h2>  </div>
                        <br />
                        <h2 className='cardpay bg-light'> <button type="button" class="btn btn-warning btn-lg">Online Payments</button>  </h2>
                        ...
                        <h2 className='choose bg-light'>{message ? <Message msg={message} /> : null}
                            ...
                            <div className='f2'>
                                <h6 className='sup bg-light'>Accepted file types: PNG, JPG, PDF</h6>
                            </div>
